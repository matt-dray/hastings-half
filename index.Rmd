...
This page is built with [R Markdown](https://rmarkdown.rstudio.com/) and [the {flexdashabord} package](https://pkgs.rstudio.com/flexdashboard/). I used [{bslib}](https://rstudio.github.io/bslib/), [{thematic}](https://rstudio.github.io/thematic/), [{emo}](https://github.com/hadley/emo) and [Google Fonts](https://fonts.google.com/) for styles, theming and embellishment.
